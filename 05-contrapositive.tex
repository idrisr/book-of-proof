...
\memodate{2024.03.09}
\status{\S 5 Contrapositive Proof}
...
\begin{prooflist} {18. If $a,b \in \mathbb{Z}$, then $(a+b)^3 \equiv a^3 + b^3
    \pmod 3$.}
    \item The original problem is the following.
        $$
            a,b \in \mathbb{Z}
...
\begin{prooflist}{19. Let $a,b, c \in \mathbb{Z}, n \in \mathbb{N}$. If a $\equiv b (\pmod  n)$ and a $\equiv c (\pmod  n)$, then $c \equiv b (\pmod  n)$.}
\item
$$
...
\begin{prooflist}{20. If $a \in \mathbb{Z}$ and $(a \equiv 1 \mod 5)$, then $(a^2 \equiv 1 \mod 5)$.}
\item
...
\begin{prooflist}{21. Let $a,b \in \mathbb{Z}$ and $n \in \mathbb{N}$. If $a
...
\begin{prooflist}{22. Let $a \in \mathbb{Z}$, $n \in \mathbb{N}$. If $a$ has remainder $r$ when divided by $n$, then $a \equiv r \mod n$.}
\item
$$
...
\begin{prooflist}{23. Let $a,b \in \mathbb{Z}$ and $n \in \mathbb{N}$. If $a
    \equiv b \mod n$, then $a^2 \equiv ab \mod n$.}
\item
...
\begin{prooflist}{24. If $a \equiv b \mod n$ and $c \equiv d \mod n$, then $ac \equiv bd \mod n$.}
...
\begin{prooflist}{25. Let $n \in \mathbb{N}$. If $2^n-1$ is prime, then $n$ is prime.}
